...
if (parseInt(na) >= 0 && parseInt(na) <= 49) {
    $('[name="grade' + x + '"]').val("D");
    $('[name="deskripsi' + x + '"]').val("Kurang Baik");
} else if (parseInt(na) >= 50 && parseInt(na) <= 69) {
    $('[name="grade' + x + '"]').val("C");
    $('[name="deskripsi' + x + '"]').val("Cukup Baik");
} else if (parseInt(na) >= 70 && parseInt(na) <= 85) {
    $('[name="grade' + x + '"]').val("B");
    $('[name="deskripsi' + x + '"]').val("Baik");
} else if (parseInt(na) >= 86 && parseInt(na) <= 100) {
    $('[name="grade' + x + '"]').val("A");
...
function infoKKM() {
    var html = 'Predikat : [D = 0 - 49] [C = 50 - 69] [B = 70 - 85] [A = 86 - 100]';
    $('#infoKKM').html(html);
}
        ...
        <div class="box-body" style="overflow-x:scroll;">
            <form action="<?=base_url('nilai/save/').$rowI->kelas_kd;?>" method="post">
                <table class="table table-bordered table-hover" style="table-layout:fixed;">
                    <thead>
                        <tr>
                            <th rowspan="2" class="text-center" width="30" style="line-height:55px;">NO</th>
                            <th rowspan="2" class="text-center" width="70" style="line-height:55px;">NIS</th>
                            <th rowspan="2" class="text-center" width="200" style="line-height:55px;">NAMA LENGKAP</th>
                            <th colspan="5" class="text-center" width="400">NILAI TUGAS</th>
                            <th rowspan="2" class="text-center" width="75" style="line-height:55px;">RNT</th>
                            <th colspan="5" class="text-center" width="400">NILAI ULANGAN</th>
                            <th rowspan="2" class="text-center" width="75" style="line-height:55px;">RNU</th>
                            <th rowspan="2" class="text-center" width="75" style="line-height:55px;">PTS</th>
                            <th rowspan="2" class="text-center" width="75" style="line-height:55px;">UAS</th>
                            <th rowspan="2" class="text-center" width="75" style="line-height:55px;">NA</th>
                            <th rowspan="2" class="text-center" width="65" style="line-height:55px;">GRADE</th>
