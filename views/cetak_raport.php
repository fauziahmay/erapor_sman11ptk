...
<body>
    ...
    <div style="page-break-after:always;">
        ...
        <h4 style="line-height:5px;text-align:center;">Dinas Pendidikan Kab. Pontianak Barat</h4> 
        <h3 style="line-height:5px;text-align:center;"><?=_school_profile()->nama;?></h3>
        
        <br>
        <p style="line-height:5px;text-align:center;margin-top:-10px;">Alamat : <?=_school_profile()->alamat;?>
        </p>
        ...
        <h4 style="line-height:5px;text-align:center;"><?=_school_profile()->nama;?></h4>
        <br>
